...
export default function Home() {
    ...
    function Chamado() {
        ...
        const ultimoSequencial = Number(localStorage.getItem('ultimoChamado')) || 0
        const numeroSequencial = ultimoSequencial + 1
        localStorage.setItem('ultimoChamado', numeroSequencial)
        setNumeroChamado(
            `${data}${String(numeroSequencial).padStart(4, '0')}`
        )
    }
    return (
